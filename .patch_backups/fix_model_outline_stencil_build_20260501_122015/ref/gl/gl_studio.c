...
{
	/* CL_MODEL_OUTLINE_STENCIL_PATCH: cvars begin */
	cl_model_outline = Cvar_Get( "cl_model_outline", "0", CVAR_ARCHIVE );
	cl_model_outline_color = Cvar_Get( "cl_model_outline_color", "0 255 80", CVAR_ARCHIVE );
	cl_model_outline_thickness = Cvar_Get( "cl_model_outline_thickness", "4.0", CVAR_ARCHIVE );
	cl_model_outline_brightness = Cvar_Get( "cl_model_outline_brightness", "1.0", CVAR_ARCHIVE );
	cl_model_outline_players_only = Cvar_Get( "cl_model_outline_players_only", "1", CVAR_ARCHIVE );
	cl_model_outline_depth_test = Cvar_Get( "cl_model_outline_depth_test", "1", CVAR_ARCHIVE );
	/* CL_MODEL_OUTLINE_STENCIL_PATCH: cvars end */
...
static void R_StudioRenderModel( void )
{
	 ...
	 */
	pglPushAttrib( GL_ENABLE_BIT | GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT | GL_STENCIL_BUFFER_BIT | GL_POLYGON_BIT | GL_CURRENT_BIT | GL_TEXTURE_BIT | GL_TRANSFORM_BIT );
