...
CVAR_DEFINE_AUTO( cl_model_outline, "0", FFCVAR_ARCHIVE, "Enable stencil outline around visible player models" );
CVAR_DEFINE_AUTO( cl_model_outline_color, "0 255 80", FFCVAR_ARCHIVE, "Outline color: R G B, accepts 0..255 or 0..1" );
CVAR_DEFINE_AUTO( cl_model_outline_thickness, "4.0", FFCVAR_ARCHIVE, "Outline thickness/scale amount" );
CVAR_DEFINE_AUTO( cl_model_outline_brightness, "1.0", FFCVAR_ARCHIVE, "Outline brightness/alpha" );
CVAR_DEFINE_AUTO( cl_model_outline_players_only, "1", FFCVAR_ARCHIVE, "Only outline player studio models" );
CVAR_DEFINE_AUTO( cl_model_outline_depth_test, "1", FFCVAR_ARCHIVE, "Keep depth test enabled so outline does not show through walls" );
